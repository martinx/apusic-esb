# -*- coding: utf-8 -*-
#
# AESB documentation build configuration file, created by
# sphinx-quickstart on Fri Aug 28 22:36:48 2009.
#
...
latex_documents = [
  ('index', 'AESB.tex', u'AESB Documentation',
   u'Martin Xu', 'manual'),
]
